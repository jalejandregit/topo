...
public class ScrapingOne {
	...
	public ScrapingOne(Parameters parameters) {
		super();
		...
		try {
			...
			System.out.println("Scrapping -> Domain:" + domain + " MAX_PAGES_TO_SEARCH=" + MAX_PAGES_TO_SEARCH);
			System.out.println("iniUrl=" + url + " OneUrl=" + OneUrl);
			search();
	...
	public void search() {
		...
		while(this.pagesVisited.size() < MAX_PAGES_TO_SEARCH){
			...
			if(currentUrl.compareTo(OneUrl)==0) {
				System.err.println("Scrapping:"+ currentUrl);
				break;
			}else {
				//System.err.println("Scrapping:"+ currentUrl + " OneUrl=" + OneUrl);
			}
	...
	public boolean crawl(String url) {
		...
		try {
			...
			for(Element link : linksOnPage)  {
				 ...
				 */
				Element profile = htmlDocument.select("div.widget.Profile").first();
				System.out.println(profile.outerHtml());
			...
			if(url.compareTo(OneUrl)==0) {
				imagenes = true;
				System.out.println("ScrapingOne.crawl() imagenes - explora " + imagenes +   "-" +  explora + " --> " +OneUrl);
